  ...
  <div class="app">
    <div class="view">
      <div class="pane">
        ...
        <p class="hint">
          Играете командами по три человека: менеджер, разработчик, тестировщик. Одна мысль на всю игру:
        ...
        <div class="roles">
          ...
          <div class="rrow"><div class="rn c1">Разработчик</div><div class="rj">Делает задачу по заявке. Видит только то, что в ней написано.</div></div>
          <div class="rrow"><div class="rn c2">Тестировщик</div><div class="rj">Проверяет работу и возвращает задачу с замечаниями.</div></div>
        </div>
      </div>
    </div>
    <div class="act">
